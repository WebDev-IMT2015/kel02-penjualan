            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/kasir/invoice/create') }}" class="btn btn-success btn-sm" title="Add New Invoice">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/kasir/invoice', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
